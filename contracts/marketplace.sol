...
contract NFT_Market is Ownable {
    ...
    // the below addresses are trusted and cons0x7c07AAfA429D952Ac3Fde9Ca037003EDB57cE14etant so no issue of re-entrancy happens
    address public constant trustedNftAddress = 0x7c07AAfA429D952Ac3Fde9Ca037003EDB57cE14e ;

    // minting fee in token, 10 tokens (10e18 because token has 18 decimals)

    uint public mintFee = 20e15;
    ...
    function mint(uint256 count) payable public {
        ...
        uint256 totalMinted = IERC721(trustedNftAddress).totalSupply();
        require (count < 21, "Max to mint is 20");
